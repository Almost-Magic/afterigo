...
SERVICES = {
    ...
    'junk-drawer-api':    {'name': 'Junk Drawer API',     'port': 5005,  'url': f'http://{LAN}:5005',  'type': 'infra', 'path': os.path.join(CK_BASE, 'Junk Drawer file management system', 'junk-drawer-backend'), 'cmd': 'python app.py', 'health': '/api/health', 'env': {'JUNK_DRAWER_PORT': '5005'}},
